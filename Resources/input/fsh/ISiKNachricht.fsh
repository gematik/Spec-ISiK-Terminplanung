...
* recipient 1..* MS
  ...
  * identifier 0..1 MS
    * ^comment = "Begründung Kardinalität und Must-Support-Flag (MS): Die Kardinalität der identifier-Eigenschaft wird auf 0..1 festgelegt, um sicherzustellen, dass optional ein Identifier vorhanden ist, da nicht davon ausgegangen werden kann, dass jeder Empfänger einer Nachricht mittels einer FHIR-Ressource repräsentiert wird."
  * display 1..1 MS
